...
n4_table = [
    ...
    [ipaddress.ip_network("34.64.0.0/24"),"googlepdns"],
    [ipaddress.ip_network("34.64.1.0/24"),"googlepdns"],
    [ipaddress.ip_network("34.64.2.0/24"),"googlepdns"],
    [ipaddress.ip_network("34.101.0.0/24"),"googlepdns"],
    [ipaddress.ip_network("34.101.1.0/24"),"googlepdns"],
    [ipaddress.ip_network("34.101.2.0/24"),"googlepdns"],
    [ipaddress.ip_network("34.116.32.0/24"),"googlepdns"],
    [ipaddress.ip_network("34.153.64.0/25"),"googlepdns"],
    [ipaddress.ip_network("34.153.64.128/26"),"googlepdns"],
    [ipaddress.ip_network("34.153.64.192/26"),"googlepdns"],
    [ipaddress.ip_network("34.153.65.0/25"),"googlepdns"],
    [ipaddress.ip_network("34.153.65.128/26"),"googlepdns"],
    [ipaddress.ip_network("34.153.65.192/26"),"googlepdns"],
    [ipaddress.ip_network("34.153.66.0/24"),"googlepdns"],
    ...
    [ipaddress.ip_network("74.114.28.0/26"),"googlepdns"],
    [ipaddress.ip_network("74.114.28.64/26"),"googlepdns"],
    [ipaddress.ip_network("74.114.28.128/26"),"googlepdns"],
    [ipaddress.ip_network("74.114.28.192/26"),"googlepdns"],
    [ipaddress.ip_network("74.114.29.0/26"),"googlepdns"],
    [ipaddress.ip_network("74.114.29.64/26"),"googlepdns"],
    [ipaddress.ip_network("74.114.29.128/26"),"googlepdns"],
    [ipaddress.ip_network("74.114.29.192/26"),"googlepdns"],
    [ipaddress.ip_network("74.114.30.0/26"),"googlepdns"],
    [ipaddress.ip_network("74.114.30.64/26"),"googlepdns"],
    [ipaddress.ip_network("74.114.30.128/25"),"googlepdns"],
    [ipaddress.ip_network("74.114.31.0/26"),"googlepdns"],
    [ipaddress.ip_network("74.114.31.64/26"),"googlepdns"],
    [ipaddress.ip_network("74.114.31.128/26"),"googlepdns"],
    [ipaddress.ip_network("74.114.31.192/26"),"googlepdns"],
    [ipaddress.ip_network("74.125.16.128/26"),"googlepdns"],
    [ipaddress.ip_network("74.125.16.192/26"),"googlepdns"],
    [ipaddress.ip_network("74.125.17.128/26"),"googlepdns"],
    [ipaddress.ip_network("74.125.17.192/26"),"googlepdns"],
    ...
    [ipaddress.ip_network("74.125.19.0/25"),"googlepdns"],
    [ipaddress.ip_network("74.125.19.128/25"),"googlepdns"],
    [ipaddress.ip_network("74.125.40.0/25"),"googlepdns"],
    [ipaddress.ip_network("74.125.40.128/26"),"googlepdns"],
    [ipaddress.ip_network("74.125.40.192/26"),"googlepdns"],
    [ipaddress.ip_network("74.125.41.0/24"),"googlepdns"],
    [ipaddress.ip_network("74.125.42.0/24"),"googlepdns"],
    [ipaddress.ip_network("74.125.43.0/25"),"googlepdns"],
    [ipaddress.ip_network("74.125.43.128/25"),"googlepdns"],
    ...
    [ipaddress.ip_network("74.125.114.128/26"),"googlepdns"],
    [ipaddress.ip_network("74.125.114.192/26"),"googlepdns"],
    ...
    [ipaddress.ip_network("74.125.179.0/25"),"googlepdns"],
    [ipaddress.ip_network("74.125.179.128/26"),"googlepdns"],
    [ipaddress.ip_network("74.125.179.192/26"),"googlepdns"],
    [ipaddress.ip_network("74.125.180.0/24"),"googlepdns"],
    [ipaddress.ip_network("74.125.181.0/25"),"googlepdns"],
    [ipaddress.ip_network("74.125.181.128/26"),"googlepdns"],
    [ipaddress.ip_network("74.125.181.192/26"),"googlepdns"],
    ...
    [ipaddress.ip_network("74.125.185.0/25"),"googlepdns"],
    [ipaddress.ip_network("74.125.185.128/26"),"googlepdns"],
    [ipaddress.ip_network("74.125.185.192/26"),"googlepdns"],
    [ipaddress.ip_network("74.125.186.0/25"),"googlepdns"],
    [ipaddress.ip_network("74.125.186.128/26"),"googlepdns"],
    [ipaddress.ip_network("74.125.186.192/26"),"googlepdns"],
    [ipaddress.ip_network("74.125.187.0/25"),"googlepdns"],
    [ipaddress.ip_network("74.125.187.128/26"),"googlepdns"],
    [ipaddress.ip_network("74.125.187.192/26"),"googlepdns"],
    ...
    [ipaddress.ip_network("172.217.32.128/26"),"googlepdns"],
    [ipaddress.ip_network("172.217.32.192/26"),"googlepdns"],
    ...
    [ipaddress.ip_network("172.217.34.128/26"),"googlepdns"],
    [ipaddress.ip_network("172.217.34.192/26"),"googlepdns"],
    [ipaddress.ip_network("172.217.35.0/26"),"googlepdns"],
    [ipaddress.ip_network("172.217.35.64/26"),"googlepdns"],
    [ipaddress.ip_network("172.217.35.128/26"),"googlepdns"],
    [ipaddress.ip_network("172.217.35.192/26"),"googlepdns"],
    [ipaddress.ip_network("172.217.36.0/24"),"googlepdns"],
    [ipaddress.ip_network("172.217.37.0/25"),"googlepdns"],
    [ipaddress.ip_network("172.217.37.128/26"),"googlepdns"],
    [ipaddress.ip_network("172.217.37.192/26"),"googlepdns"],
    [ipaddress.ip_network("172.217.38.0/25"),"googlepdns"],
    [ipaddress.ip_network("172.217.38.128/26"),"googlepdns"],
    [ipaddress.ip_network("172.217.38.192/26"),"googlepdns"],
    [ipaddress.ip_network("172.217.39.128/26"),"googlepdns"],
    [ipaddress.ip_network("172.217.39.192/26"),"googlepdns"],
    [ipaddress.ip_network("172.217.40.0/25"),"googlepdns"],
    [ipaddress.ip_network("172.217.40.128/25"),"googlepdns"],
    [ipaddress.ip_network("172.217.41.0/25"),"googlepdns"],
    [ipaddress.ip_network("172.217
25"),"googlepdns"],
    [ipaddress.ip_network("192.178.36.128/26"),"googlepdns"],
    [ipaddress.ip_network("192.178.36.192/26"),"googlepdns"],
    [ipaddress.ip_network("192.178.37.0/26"),"googlepdns"],
    [ipaddress.ip_network("192.178.37.64/26"),"googlepdns"],
    [ipaddress.ip_network("192.178.37.128/25"),"googlepdns"],
    [ipaddress.ip_network("192.178.38.0/26"),"googlepdns"],
    [ipaddress.ip_network("192.178.38.64/26"),"googlepdns"],
    [ipaddress.ip_network("192.178.38.128/26"),"googlepdns"],
    [ipaddress.ip_network("192.178.38.192/26"),"googlepdns"],
    [ipaddress.ip_network("192.178.39.0/26"),"googlepdns"],
    [ipaddress.ip_network("192.178.39.64/26"),"googlepdns"],
    [ipaddress.ip_network("192.178.39.128/25"),"googlepdns"],
    [ipaddress.ip_network("192.178.64.0/24"),"googlepdns"],
    [ipaddress.ip_network("192.178.65.0/26"),"googlepdns"],
    [ipaddress.ip_network("192.178.65.64/26"),"googlepdns"],
    [ipaddress.ip_network("192.178.65.128/25"),"googlepdns"],
    [ipaddress.ip_network("192.178.66.0/25"),"googlepdns"],
    [ipaddress.ip_network("192.178.66.128/25"),"googlepdns"],
    [ipaddress.ip_network("192.178.67.0/26"),"googlepdns"],
    [ipaddress.ip_network("192.178.67.64/26"),"googlepdns"],
    [ipaddress.ip_network("192.178.67.128/25"),"googlepdns"],
    [ipaddress.ip_network("192.178.92.0/26"),"googlepdns"],
    [ipaddress.ip_network("192.178.92.64/26"),"googlepdns"],
    [ipaddress.ip_network("192.178.92.128/26"),"googlepdns"],
    [ipaddress.ip_network("192.178.92.192/26"),"googlepdns"],
    [ipaddress.ip_network("192.178.93.0/26"),"googlepdns"],
    [ipaddress.ip_network("192.178.93.64/26"),"googlepdns"],
    [ipaddress.ip_network("192.178.93.128/26"),"googlepdns"],
    [ipaddress.ip_network("192.178.93.192/26"),"googlepdns"],
    [ipaddress.ip_network("192.178.94.0/26"),"googlepdns"],
    [ipaddress.ip_network("192.178.94.64/26"),"googlepdns"],
    [ipaddress.ip_network("192.178.94.128/26"),"googlepdns"],
    [ipaddress.ip_network("192.178.94.192/26"),"googlepdns"],
    [ipaddress.ip_network("192.178.95.0/26"),"googlepdns"],
    [ipaddress.ip_network("192.178.95.64/26"),"googlepdns"],
    [ipaddress.ip_network("192.178.95.128/25"),"googlepdns"],
    [ipaddress.ip_network("192.178.112.0/26"),"googlepdns"],
    [ipaddress.ip_network("192.178.112.64/26"),"googlepdns"],
    [ipaddress.ip_network("192.178.112.128/26"),"googlepdns"],
    [ipaddress.ip_network("192.178.112.192/26"),"googlepdns"],
    [ipaddress.ip_network("192.178.113.0/26"),"googlepdns"],
    [ipaddress.ip_network("192.178.113.64/26"),"googlepdns"],
    [ipaddress.ip_network("192.178.113.128/26"),"googlepdns"],
    [ipaddress.ip_network("192.178.113.192/26"),"googlepdns"],
    [ipaddress.ip_network("192.178.114.0/25"),"googlepdns"],
    [ipaddress.ip_network("192.178.114.128/25"),"googlepdns"],
    [ipaddress.ip_network("192.178.115.0/26"),"googlepdns"],
    [ipaddress.ip_network("192.178.115.64/26"),"googlepdns"],
    [ipaddress.ip_network("192.178.115.128/26"),"googlepdns"],
    [ipaddress.ip_network("192.178.115.192/26"),"googlepdns"],
    [ipaddress.ip_network("192.178.116.0/26"),"googlepdns"],
    [ipaddress.ip_network("192.178.116.64/26"),"googlepdns"],
    [ipaddress.ip_network("192.178.116.128/25"),"googlepdns"],
    [ipaddress.ip_network("192.178.117.0/25"),"googlepdns"],
    [ipaddress.ip_network("192.178.117.128/26"),"googlepdns"],
    [ipaddress.ip_network("192.178.117.192/26"),"googlepdns"],
    [ipaddress.ip_network("192.178.118.0/26"),"googlepdns"],
    [ipaddress.ip_network("192.178.118.64/26"),"googlepdns"],
    [ipaddress.ip_network("192.178.118.128/26"),"googlepdns"],
    [ipaddress.ip_network("192.178.118.192/26"),"googlepdns"],
    [ipaddress.ip_network("192.178.119.0/26"),"googlepdns"],
    [ipaddress.ip_network("192.178.119.64/26"),"googlepdns"],
    [ipaddress.ip_network("192.178.119.128/25"),"googlepdns"],
...
n6_table = [
    ...
    [ipaddress.ip_network("2404:6800:400a:1000::/62"),"googlepdns"],
    [ipaddress.ip_network("2404:6800:400a:1004::/62"),"googlepdns"],
    [ipaddress.ip_network("2404:6800:400a:1008::/61"),"googlepdns"],
    [ipaddress.ip_network("2404:6800:400b:c000::/62"),"googlepdns"],
    [ipaddress.ip_network("2404:6800:400b:c004::/62"),"googlepdns"],
    [ipaddress.ip_network("2404:6800:400b:c008::/61"),"googlepdns"],
    [ipaddress.ip_network("2404:6800:400b:c010::/60"),"googlepdns"],
    [ipaddress.ip_network("2404:6800:4013::/53"),"googlepdns"],
    [ipaddress.ip_network("2404:6800:4013:800::/53"),"googlepdns"],
    [ipaddress.ip_network("2404:6800:4016::/48"),"googlepdns"],
    [ipaddress.ip_network("2404:f340:10:1400::/61"),"googlepdns"],
    [ipaddress.ip_network("2404:f340:10:1408::/61"),"googlepdns"],
    [ipaddress.ip_network("2404:f340:4010::/48"),"googlepdns"],
    [ipaddress.ip_network("2406:f400:22::/48"),"freenom"],
    [ipaddress.ip_network("2600:1900::/48"),"googlepdns"],
    [ipaddress.ip_network("2600:1900:4260::/54"),"googlepdns"],
    [ipaddress.ip_network("2600:1900:4260:400::/61"),"googlepdns"],
    [ipaddress.ip_network("2600:1900:4260:408::/61"),"googlepdns"],
    [ipaddress.ip_network("2607:f7a0:1::/48"),"freenom"],
    [ipaddress.ip_network("2607:f8b0:4001:c00::/59"),"googlepdns"],
    [ipaddress.ip_network("2607:f8b0:4001:c20::/61"),"googlepdns"],
    [ipaddress.ip_network("2607:f8b0:4001:c28::/62"),"googlepdns"],
    [ipaddress.ip_network("2607:f8b0:4001:c2e::/64"),"googlepdns"],
    [ipaddress.ip_network("2607:f8b0:4001:c2f::/64"),"googlepdns"],
    [ipaddress.ip_network("2607:f8b0:4001:c30::/62"),"googlepdns"],
    [ipaddress.ip_network("2607:f8b0:4001:c34::/62"),"googlepdns"],
    [ipaddress.ip_network("2607:f8b0:4001:c40::/60"),"googlepdns"],
    [ipaddress.ip_network("2607:f8b0:4001:c50::/61"),"googlepdns"],
    [ipaddress.ip_network("2607:f8b0:4001:c58::/63"),"googlepdns"],
    [ipaddress.ip_network("2607:f8b0:4001:c5a::/63"),"googlepdns"],
    [ipaddress.ip_network("2607:f8b0:4001:c5c::/62"),"googlepdns"],
    [ipaddress.ip_network("2607:f8b0:4001:c60::/63"),"googlepdns"],
    [ipaddress.ip_network("2607:f8b0:4001:c62::/63"),"googlepdns"],
    [ipaddress.ip_network("2607:f8b0:4001:c64::/62"),"googlepdns"],
    [ipaddress.ip_network("2607:f8b0:4001:c68::/63"),"googlepdns"],
    [ipaddress.ip_network("2607:f8b0:4001:c6a::/63"),"googlepdns"],
    [ipaddress.ip_network("2607:f8b0:4001:c6c::/63"),"googlepdns"],
    [ipaddress.ip_network("2607:f8b0:4001:c6e::/63"),"googlepdns"],
    [ipaddress.ip_network("2607:f8b0:4001:c70::/62"),"googlepdns"],
    [ipaddress.ip_network("2607:f8b0:4001:c74::/62"),"googlepdns"],
    ...
    [ipaddress.ip_network("2607:f8b0:4023::/54"),"googlepdns"],
    [ipaddress.ip_network("2607:f8b0:4023:400::/54"),"googlepdns"],
    [ipaddress.ip_network("2607:f8b0:4023:800::/54"),"googlepdns"],
    [ipaddress.ip_network("2607:f8b0:4023:c00::/54"),"googlepdns"],
    [ipaddress.ip_network("2607:f8b0:4023:1000::/54"),"googlepdns"],
    [ipaddress.ip_network("2607:f8b0:4023:1400::/54"),"googlepdns"],
    [ipaddress.ip_network("2607:f8b0:4023:1800::/54"),"googlepdns"],
    [ipaddress.ip_network("2607:f8b0:4023:1c00::/54"),"googlepdns"],
    [ipaddress.ip_network("2607:f8b0:4023:2000::/54"),"googlepdns"],
    [ipaddress.ip_network("2607:f8b0:4023:2400::/62"),"googlepdns"],
    [ipaddress.ip_network("2607:f8b0:4023:2404::/63"),"googlepdns"],
    [ipaddress.ip_network("2607:f8b0:4023:2406::/63"),"googlepdns"],
    [ipaddress.ip_network("2607:f8b0:4023:2800::/54"),"googlepdns"],
    [ipaddress.ip_network("2607:f8b0:4023:2c00::/54"),"googlepdns"],
    [ipaddress.ip_network("2607:f8b0:4023:3000::/54"),"googlepdns"],
    [ipaddress.ip_network("2607:f8b0:4023:3400::/54"),"googlepdns"],
    [ipaddress.ip_network("2607:f8b0:4024::/48"),"googlepdns"],
    ...
    [ipaddress.ip_network("2a00:1450:4008:c00::/62"),"googlepdns"],
    [ipaddress.ip_network("2a00:1450:4008:c04::/62"),"googlepdns"],
    [ipaddress.ip_network("2a00:1450:4009::/48"),"googlepdns"],
    [ipaddress.ip_network("2a00:1450:400a:1000::/62"),"googlepdns"],
    [ipaddress.ip_network("2a00:1450:400a:1004::/62"),"googlepdns"],
    [ipaddress.ip_network("2a00:1450:400a:1008::/61"),"googlepdns"],
    ...
    [ipaddress.ip_network("2a00:1450:4025::/53"),"googlepdns"],
    [ipaddress.ip_network("2a00:1450:4025:800::/54"),"googlepdns"],
    [ipaddress.ip_network("2a00:1450:4025:c00::/54"),"googlepdns"],
    [ipaddress.ip_network("2a00:1450:4025:1000::/54"),"googlepdns"],
    [ipaddress.ip_network("2a00:1450:4025:1400::/54"),"googlepdns"],
    [ipaddress.ip_network("2a00:1450:4025:1800::/54"),"googlepdns"],
    [ipaddress.ip_network("2a00:1450:4025:1c00::/54"),"googlepdns"],
    [ipaddress.ip_network("2a00:1450:4025:2000::/54"),"googlepdns"],
    [ipaddress.ip_network("2a00:1450:4025:2400::/54"),"googlepdns"],
    [ipaddress.ip_network("2a00:1450:4025:3000::/52"),"googlepdns"],
    [ipaddress.ip_network("2a00:1450:4025:4000::/62"),"googlepdns"],
    [ipaddress.ip_network("2a00:1450:4025:4004::/62"),"googlepdns"],
    [ipaddress.ip_network("2a00:1450:4030::/48"),"googlepdns"],
    ...
    [ipaddress.ip_network("2c0f:fb50:4001::/48"),"googlepdns"],
]
...
def get_open_rsv_from_IP(resolver_IP):
    found = ""
    try:
        key = ipaddress.ip_address(resolver_IP)
    except:
        return ""
    if key.version == 4:
        table = n4_table
    ...
    if key in r_low[0]:
        found = r_low[1]
        #print("R_low[0] " + str(r_low[0]) + " contains " + resolver_IP)
    elif r_low[0].network_address < key:
        r_high = table[x_high]
        if key in r_high[0]:
            #print("R_high[0] " + str(r_high[0]) + " contains " + resolver_IP)
            found = r_high[1]
        elif r_high[0].network_address > key:
            #print("r_high[" + str(x_high) + ": " + str(r_high[0]) + " > " + resolver_IP)
            while x_low != x_high:
                x_mid = int((x_low + x_high) / 2)
                if x_mid == x_low:
                    #print("x_mid: " + str(x_mid) + " == x_low: " + str(x_low))
                    break
                else:
                    r_mid = table[x_mid]
                    #print("r_mid[" + str(x_mid) + "] = " + str(r_mid[0]))
                    if key in r_mid[0]:
                        #print("r_mid[" + str(x_mid) + "] " + str(r_high[0].network_address) + " contains " + resolver_IP)
                        found = r_mid[1]
                        break
                    elif r_mid[0].network_address > key:
                        #print("r_mid[" + str(x_mid) + "] " + str(r_mid[0].network_address) + " > " + resolver_IP)
                        x_high = x_mid
                        #r_high = table[x_high]
                        #print("r_high[" + str(x_high) + "] = " + str(r_high[0]))
                    else:
                        #print("r_mid[" + str(x_mid) + "] " + str(r_mid[0].network_address) + " < " + resolver_IP)
                        x_low = x_mid   
                        #r_low = table[x_low] 
                        #print("r_low[" + str(x_low) + "] = " + str(r_low[0]))
        else:
            #print("r_high[0] " + str(r_high[0].network_address) + " < " + resolver_IP)
            pass
    else:
        #print(str(r_low[0].network_address) + " > " + resolver_IP)
        pass
    return found

def get_open_rsv(resolver_IP, resolver_AS):
    found = get_open_rsv_from_AS(resolver_AS)
    if found == "":
        found = get_open_rsv_from_IP(resolver_IP)
    return found
