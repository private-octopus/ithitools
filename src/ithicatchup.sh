...
DATE_DASH=$(date -d $DATE_CURRENT +%Y-
...
find /home/rarends/data/$DATE* | grep ".csv" > 3_catch_month.txt
echo "Found $(wc -l 3_catch_month.txt) files in /home/rarends/data/$DATE*"
