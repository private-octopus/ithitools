...
# coding=utf-8
#
# This module provides the list of tlds in 3 categories:
#  reserved: reserved per RFC6762
#  frequent: observed in list of frequent leaks at the root
#  tlds: registered per ICANN processes

reserved = [ "EXAMPLE", "INVALID", "LOCAL", "LOCALHOST", "ONION", "TEST" ]

frequent = [
    "_MSDCS", "_TCP", "_UDP", "ALARMSERVER", "AN", "ASUS", "BELKIN",
    "BLINKAP", "C3T", "COMHTTP", "CORP", "CPE", "DANET", "DAVOLINK",
    "DEF", "DHCP", "DLINK", "DLINKROUTER", "DNS", "DOM", "DOMAIN", "DS", 
    "FACEBOOK", "FCNAME", "GATEWAY", "GOTHAN", "GREATEK", "GRP", "HOME",
    "HOMESTATION", "HOTSPOT300", "HTM", "HTML", "HTTP", "INTERN", "INTERNAL",
    "INTRA", "INTRANET", "INTRAXA", "JPG", "KROSSPRECISION", "LAN",
    "LCL", "LD", "LOC", "LOCALDOMAIN", "LVMH", "MAIL", "MAXPRINT", "MINIHUB",
    "MP3", "MULTILASERAP", "MYMAX", "NONE", "NULL", "NUPROSM", "OIWTECH",
    "OLX", "PHP", "PIXEL", "PNG", "PRI", "PRIV", "PVT", "ROOT", "ROUTER",
    "SETUP", "SNECMA", "SOCGEN", "SOPRA", "SYS", "TLD", "TOTOLINK", "TP",
    "UAPROM", "UFU", "UNIFI", "VDS", "WIRELESSAP", "WORKGROUP", "WPAD",
    "WWW", "XML", "YU", "ZYXEL-USG"]
